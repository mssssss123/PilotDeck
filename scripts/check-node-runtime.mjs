...
if (!isAtLeastMinimum(nodeVersion) || !isSupportedMajor(nodeVersion)) {
  fail(
    `Node.js ${nodeVersionRequirementLabel} is required because 九格智能体平台 uses node:sqlite and native packages are built for Node.js ${supportedNodeMajor}. Current: ${formatNodeVersion(nodeVersion)}. Switch to Node.js ${supportedNodeMajor} and reinstall dependencies.`,
  );
}
