...
- **[2026.05.28 · 上游动态]** PilotDeck 正式开源！欢迎访问官网 [pilotdeck.openbmb.cn](https://pilotdeck.openbmb.cn)，期待社区的贡献、反馈与 Star 支持。
...
> 以下所有演示均由端侧模型通过上游 PilotDeck 智能路由完成生成——无需调用云端大模型。
...
```bash
9gclaw            # 在 http://localhost:3001 启动服务
...
- 关于技术问题及功能请求，请提交 [GitHub Issues](https://github.com/mssssss123/PilotDeck/issues)。
- 欢迎加入我们的社区与我们交流：
...
<p align="center">
  上游 PilotDeck 由清华大学 <a href="https://nlp.csai.tsinghua.edu.cn/">THUNLP</a>、<a href="https://modelbest.cn/">面壁智能</a>、<a href="https://www.openbmb.cn/">OpenBMB</a> 与 <a href="https://github.com/AI9Stars">AI9Stars</a> 联合研发。
</p>
